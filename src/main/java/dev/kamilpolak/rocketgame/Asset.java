...
public enum Asset {
    ...
    LAUNCHPAD_TEXTURE("assets/textures/earth.png", Texture.class),
    MOUNTAINS_TEXTURE("assets/textures/trees.png", Texture.class),
    TREES_TEXTURE("assets/textures/mountains.png", Texture.class);
